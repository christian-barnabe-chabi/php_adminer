...
class ResourceScaffold {
    ...
    public static function render() {
        ...
        echo"
            <div class='ui secondary segment {$primary_color} {$inverted} vertical menu fixed' id='side-menu' style='overflow: auto; {$bg_white}; padding: 5px 5px; box-shadow: 4px 0px 5px rgba(0,0,0,0.1)'>".
